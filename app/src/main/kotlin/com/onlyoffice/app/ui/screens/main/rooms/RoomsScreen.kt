...
fun RoomsScreen(
    ...
    BackHandler(enabled = viewModel.roomsData?.currentFolder?.isRootFolder() == false) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        text = viewModel.roomsData?.currentFolder?.title
                ...
                navigationIcon = {
                    AnimatedVisibility(
                        visible = viewModel.roomsData?.currentFolder?.isRootFolder() == false,
                        enter = fadeIn(),
                        exit = fadeOut()
                    ) {
        ...
        FullScreenContentWithLoading(
            ...
            Crossfade(
                targetState = viewModel.roomsData?.takeUnless {
                ...
                when (roomsData) {
                    null -> Box(
                        ...
                        Text(
                            text = stringResource(R.string.empty_room_placeholder),
